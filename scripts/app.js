...
$('#btValider').click(function() {
    ...
    $.ajax({
        ...
        success: function() {
            swal('Data Berhasil Disimpan', 'Data pegawai disimpan', 'success')
                .then(() => {
                    location.reload();
                });
        }
...
$('#btUpdateClient').click(function() {
    ...
    $.ajax({
        ...
        success: function() {
            swal('Edit Data Pegawai', 'Data berhasil diperbarui', 'berhasil')
                .then(() => {
                    location.reload();
                });
        }
        ...
        .then((willCancel) => {
            if (willCancel) {
                $.ajax({
                    ...
                    success: function() {
                        swal('Dihapus !', 'Data pegawai berhasil dihapus', 'berhasil')
                            .then(() => {
                                location.reload();
                            });
                    },
                ...
                swal("Data pegawai belum dihapus");
            }
        });
}